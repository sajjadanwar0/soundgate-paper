...
- [~] MECHANIZED VERIFICATION -- three tiers written; FIRST RUN RESULTS:
  ...
  DecidePreserves rewritten as per-disjunct CASE splits (the monolithic
  BY DEF exceeded the backends; 22/24 had proved). RERUN all three:
...
- [ ] YOUR SIDE -- de-anonymization decision (FW-A..F vs named frameworks;
  ...
  names them) and full author read-through of the 7-page draft
