// mediation_guard_full.c -- COMPLETE-channel egress mediation (reviewer W2:
...
//   clang -O2 -g -target bpf -c mediation_guard_full.c -o mediation_guard_full.o
//   for s in connect4 connect6 sendmsg4 sendmsg6; do \
//     bpftool prog load mediation_guard_full.o /sys/fs/bpf/mg_$s \
